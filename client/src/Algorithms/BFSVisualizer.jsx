...
const BFSVisualizer = () => {
  ...
  const generateRandomGraph = (size) => {
    ...
    resetSearch();
    setExplanation(`Random graph with ${size} nodes generated. Select a start node and begin BFS.`);
  };
  ...
  const generateBFSSteps = () => {
    ...
    newSteps.push({
      ...
      currentNode: null,
      explanation: `Step ${++stepCount}: Start from node ${startNode}. Enqueue ${startNode}. Queue = [${queue.join(', ')}]`,
      line: 1
    });
    ...
    while (queue.length > 0) {
      ...
      newSteps.push({
        ...
        visited: new Set(visited),
        currentNode: current,
        explanation: `Step ${++stepCount}: Dequeue ${current}. Visit ${current}.`,
        line: 5
      });
      ...
      for (const neighbor of neighbors) {
        if (!visited.has(neighbor)) {
          ...
          newSteps.push({
            ...
            visited: new Set(visited),
            currentNode: current,
            explanation: `Step ${++stepCount}: Discover neighbor ${neighbor} of ${current}. Enqueue ${neighbor}. Queue = [${queue.join(', ')}]`,
            line: 7
          });
        }
      }
      ...
      if (!neighborsAdded && neighbors.length > 0) {
        newSteps.push({
          ...
          visited: new Set(visited),
          currentNode: current,
          explanation: `Step ${++stepCount}: All neighbors of ${current} already visited. Queue = [${queue.join(', ')}]`,
          line: 5
        });
      }
      ...
      newSteps.push({
        ...
        visited: new Set(visited),
        currentNode: null,
        explanation: `Step ${++stepCount}: Finished processing ${current}. Queue = [${queue.join(', ')}]`,
        line: 5
      });
    }
    ...
    newSteps.push({
      ...
      visited: new Set(visited),
      currentNode: null,
      explanation: `BFS completed! Visited ${visited.size} nodes: [${Array.from(visited).join(', ')}]`,
      line: 9
    });
  ...
  const getNodeColor = (nodeId) => {
    ...
    if (queueNodes.includes(nodeId)) return 'bg-orange-500'; // Nodes in queue
    ...
    <div className="pt-22 min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 p-6 overflow-x-hidden relative">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-4xl font-bold text-white mb-2">Breadth First Search (BFS) Algorithm</h1>
          <p className="text-lg text-gray-300">
            BFS explores a graph level by level, starting from a source node. It visits all neighbors before moving to the next level.
        ...
        <div className="bg-gray-800/50 backdrop-blur-md rounded-xl p-6 mb-6 shadow-xl">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            ...
            {/* Start Node */}
            <div className="flex flex-col space-y-2">
              <label className="text-gray-300 text-sm">Start Node for BFS:</label>
              <div className="flex">
                <select
                  value={startNode}
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                ...
                <option value="queue">Queue Nodes</option>
  ...
  {node.id}
          ...
          <div className="bg-gray-800/50 backdrop-blur-md rounded-xl p-6 shadow-xl">
            ...
            <div className="h-80 bg-gray-900/50 rounded-lg border border-gray-700 p-4">
              <div className="text-gray-300 mb-2">Current Queue:</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {/* Code Snippet Panel */}
          <div className="bg-gray-800/50 backdrop-blur-md rounded-xl p-6 shadow-xl">
            <h2 className="text-xl font-semibold text-white mb-4">BFS Algorithm</h2>
        ...
        <div className="mt-6 bg-gray-800/50 backdrop-blur-md rounded-xl p-6 shadow-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="bg-gray-900/50 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-500">Queue + visited array</p>
            </div>
