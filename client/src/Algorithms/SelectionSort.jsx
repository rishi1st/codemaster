...
const SelectionSort = () => {
  ...
  const [highlightMode, setHighlightMode] = useState('min');
  ...
  const generateSteps = () => {
    ...
    for (let i = 0; i < n - 1; i++) {
      ...
      newSteps.push({
        ...
        comparisons: comparisons,
        swaps: swaps,
        explanation: `Starting pass ${i + 1}. Setting minimum index to ${i} (value: ${arr[i]}).`,
        line: 4
      });
      ...
      for (let j = i + 1; j < n; j++) {
        ...
        newSteps.push({
          ...
          comparisons: comparisons,
          swaps: swaps,
          explanation: `Comparing ${arr[j]} at index ${j} with current minimum ${arr[minIdx]} at index ${minIdx}.`,
          line: 5
        });

        if (arr[j] < arr[minIdx]) {
          minIdx = j;
          // Update min index step
          newSteps.push({
            array: [...arr],
            compared: [minIdx],
            minIndex: minIdx,
            ...
            comparisons: comparisons,
            swaps: swaps,
            explanation: `New minimum found: ${arr[minIdx]} at index ${minIdx}. Updating minimum index.`,
            line: 6
          });
        }
      }
      ...
      if (minIdx !== i) {
        ...
        newSteps.push({
          ...
          comparisons: comparisons,
          swaps: swaps,
          explanation: `Swapping ${arr[minIdx]} at index ${minIdx} with ${arr[i]} at index ${i}.`,
          line: 9
        });
      }
      ...
      newSteps.push({
        ...
        comparisons: comparisons,
        swaps: swaps,
        explanation: `Pass ${i + 1} completed. Element at index ${i} is now in its sorted position.`,
        line: i === n - 2 ? 11 : 2
      });
    }

    // Final sorted state - mark all as sorted
    ...
    <div className="pt-22 min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 p-6 overflow-x-hidden relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-4xl font-bold text-white mb-2">Selection Sort Algorithm</h1>
        ...
        <div className="bg-gray-800/50 backdrop-blur-md rounded-xl p-6 mb-6 shadow-xl">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                <option value="min">Minimum Element</option>
          ...
          <div className="flex items-end justify-center h-64" style={{ gap: '2px' }}>
            {array.map((value, index) => {
              ...
              if (sortedIndices.has(index)) {
                ...
                backgroundColor = 'bg-yellow-500'; // Current minimum
              } else if (
                ...
                backgroundColor = 'bg-cyan-500'; // Current index
              }
        ...
        <div className="mt-6 bg-gray-800/50 backdrop-blur-md rounded-xl p-6 shadow-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-gray-900/50 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-500">Even if array is sorted</p>
            </div>
            <div className="bg-gray-900/50 p-4 rounded-lg">
